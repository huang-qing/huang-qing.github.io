...
Github 官方专门制作了一个网站[choosealicense](https://choosealicense.com/licenses/)帮助大家选择合适的开源License。
...
`MPL` ，也就是 Mozilla Public License 就温和一些，如果后续开发的代码中添加了新文件，同时新文件中也没有用到原来的代码，那么新文件可以不必继续沿用 MPL 。


## 开源许可证GPL、BSD、MIT、Mozilla、Apache和LGPL的区别

![](/images/github/license-workflow.jpg)

![license.jpg](/images/github/license.jpg)
